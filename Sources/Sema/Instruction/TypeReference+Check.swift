...
extension TypeReference {
    func resolve(context: FunctionParsingContext) -> SType {
        ...
        case .generic(let generic):
            ...
            context.typeChecker.diagnostics.append(Diagnostic(token: generic.name, message: TypeCheckDiagnosticMessage.unknownType(generic.name.identifier), severity: .error))
